  ...
  return (
    ...
    >
      <div className='relative xl:2-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:test-[72px] max-sm:leading-[82] font-bold">
          <span className="xl:bg-white xl:whitespace0nowrap relative z-10 pr-10">The New Arrival</span>
          <br />
